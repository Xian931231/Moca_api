(function($) {
    $.fn.customPaging = function(option, callback) {
        ...
        function _drawPage(totalCount) {
			...
			var prev_o = $("<a>").addClass("page-link").attr({ "href": "javascript:;", "aria-label": "Previous" }).html("<span aria-hidden='true'>‹</span>");
            ...
            var next_o = $("<a>").addClass("page-link").attr({ "href": "javascript:;", "aria-label": "Next" }).html("<span aria-hidden='true'>›</span>");
