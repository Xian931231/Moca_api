			...
			"method": [
				...
				},
				{
					...
					"info": {
						...
						"reqParam": [
							{
								"name":"schedule_date", "type":"string", "req":"yes", "value":"2023-10-30",
								"desc":"편성표 정보를 요청할 날쨔"
							},
							{
								"name":"device_number", "type":"string", "req":"yes", "value":"",
								"desc":"디바이스 식별 번호"
							},
						],
						"respParam": [
				...
				},
				{
					...
					"info": {
						...
						"reqParam": [
							{
								"name":"sg_id", "type":"int", "req":"yes", "value":"303",
								"desc":"광고 아이디"
							},
							{
								"name":"sg_kind", "type":"int", "req":"yes", "value":"CPM",
								"desc":"광고 종류(CPP, AREA, TIME, CPM, PUBLIC, DEFAULT)"
							},
							{
								"name":"schedule_date", "type":"int", "req":"yes", "value":"2023-10-30",
								"desc":"스케쥴 일자"
							},
							{
								"name":"device_number", "type":"string", "req":"yes", "value":"",
				...
				},
				{
					...
					"info": {
						...
						"reqParam": [
							{
								"name":"event_date", "type":"string", "req":"yes", "value":"2023-07-04 16:38:26.122",
								"desc":"해당 광고에 대한 이벤트 실제 발생 시간"
							},
							{
								"name":"sg_id", "type":"int", "req":"yes", "value":"",
								"desc":"광고 아이디"
							},
							{
							...
							{
								"name":"slot_id", "type":"int", "req":"yes", "value":"",
								"desc":"편성표 슬롯 코드"
							},
							{
								"name":"device_number", "type":"string", "req":"yes", "value":"",
							...
							{
								"name":"event_kind", "type":"string", "req":"yes", "value":"",
